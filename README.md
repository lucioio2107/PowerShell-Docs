...
This project has adopted the [Microsoft Open Source Code of Conduct][04].
 Updatable Help (CabGen) CI Build Status

[![Build Status][cabgen-status]][cabgen-log]

[cabgen-status]: https://apidrop.visualstudio.com/Content%20CI/_apis/build/status/PROD/CabGen(Updatable_Help)/GitHub_MicrosoftDocs_Docs/6ff7e8c3-dfc6-3ebd-da5a-d5e2ff43de8f_cabgen_Updatable-Help?repoName=MicrosoftDocs%2F-Docs&branchName=live
[cabgen-log]: https://apidrop.visualstudio.com/Content%20CI/_build/latest?definitionId=5076&repoName=MicrosoftDocs%2FPower-Docs&branchName=live
...
Contribution  This is a one-time requirement.
...
There are two license files  The applies to the code contained in
this repo. The applies to the documentation.

 link references 
[01]: https://learn.microsoft.com/scripting/
